...
### Task 0.2 — Create lib.rs with mobile entry point [ ]
...
### Task 0.4 — Rewrite tauri.conf.json to v2 [ ]
...
### Task 0.5 — Create capabilities/default.json [ ]
...
### Task 0.8 — Update updateStore.ts [ ]
